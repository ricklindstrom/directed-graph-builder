...
BUILDING
--------
  * Directed graphs - Primarily graphviz files (but also TGF files)
...
This is a simple project still in its early stages, but it has the potential, even in its current state, to be useful. So please share it or help contribute to it.
